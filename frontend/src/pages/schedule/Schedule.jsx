...
const Schedule = () => {
    ...
    return (
        <main className="relative mb-10">
            <div className="flex flex-col justify-center items-center mt-7 mx-7">
            ...
            <section className="flex flex-row max-md:flex-col justify-around max-md:justify-center md:mt-4">
                ...
                <div className=" max-md:self-center grid grid-cols-3 max-md:grid-cols-1 max-lg:grid-cols-2 items-stretch gap-5 w-[70%] max-md:w-[65%] min-w-80 ms-4 me-[10%] max-md:mx-20 max-lg:me-24">
                    {fullSchedule && fullSchedule.map((event) => <EventCard key={event.dateFormatted} event={event}/>)}
                </div>
            </section>
        </main>
    );
